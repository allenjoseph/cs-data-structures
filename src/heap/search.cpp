...
// Tu programa debe insertar elementos a un arbol binario y retornar el numero de comparaciones realizadas para encontrar un valor buscado.
// Entrada: elementos a insertarse en el arbol y un valor buscado. Con -1 se termina la entrada y no debe ser considerado. Salida: el numero nodos del arbol con los que se compara para encontrar el valor
// Se asume que siempre el valor buscado estara dentro del arbol
// Input Format
// 13
// 7
// 15
...
// -1
// Constraints
// Debes implementar un arbol binario
// Output Format
// 4
...
int main()
{
  ...
  if (elemento != -1)
  {
    cout << arbol->recorrido(elemento) << endl;
  }
